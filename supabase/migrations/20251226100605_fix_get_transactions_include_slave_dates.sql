-- Fix get_transactions to also include transactions where a slave date is in the range
-- This is needed for "comptable" mode which filters by slave date, not master date
-- Example: A CCA paid in December 2025 with a slave dated April 2026 should be returned
-- when querying for April 2026
